...
import { View, StyleSheet, StatusBar, Image, TouchableOpacity, Alert, Text } from 'react-native';
...
const Wishlist = ({ navigation }) => {
  ...
  return (
    <View>
      ...
      <Appbar.Header style={{ backgroundColor: '#FAAC2C' }}>
        {/* <Appbar.Action icon="menu" iconColor='white' onPress={() =>{setModal('ACTION_2'); setModalVisible(!isModalVisible); }} />  */}
        <AntDesign name="arrowleft" size={25} marginLeft={5} color="white" onPress={() => { navigation.navigate('FirstScreen') }} />
        <Appbar.Content title="Wishlist" titleStyle={{ color: "white", marginLeft: 10, fontWeight: 'bold' }} />
        ...
        <Appbar.Action icon="dots-vertical" iconColor='white' onPress={() => { createThreeButtonAlert }} />
      </Appbar.Header>
